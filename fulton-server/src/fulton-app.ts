...
import { AppMode, DiContainer, EntityServiceFactory, ICacheServiceFactory, ICacheService, IEntityService, INotificationService, NotificationMessage, Response, Type, TypeIdentifier } from './interfaces';
...
export abstract class FultonApp implements IFultonApp {
    ...
    getCacheService(category?: string): ICacheService {
        if (this.options.cache.enabled) {
            return this.container.get<ICacheServiceFactory>(DiKeys.CacheServiceFactory).getCacheService(category)
        }
